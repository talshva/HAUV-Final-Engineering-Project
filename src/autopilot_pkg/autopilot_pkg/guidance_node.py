...
class GuidanceNode(Node):
    ...
    def joy_callback(self, msg):
        # Axis 4 is usually the right stick vertical axis
        self.joy_speed = msg.axes[4]
    ...
    def motor_light_publisher(self):
        ...
        self.motor_velocity["motor1"] = motor_pwm
        self.motor_velocity["motor2"] = motor_pwm
        self.motor_velocity["motor3"] = motor_pwm
        self.motor_velocity["motor4"] = motor_pwm
        self.motor_velocity["motor5"] = motor_pwm

        # Calculate light intensity based on absolute difference from 1500
        light_intensity = int((abs(motor_pwm - 1500) / 400) * 800 + 1100)
        if motor_pwm == 1500:
            light_intensity = 1100

        self.light_intensity["light1"] = light_intensity
        self.light_intensity["light2"] = light_intensity
        self.light_intensity["light_couple"] = light_intensity
